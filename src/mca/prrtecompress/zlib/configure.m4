...
# MCA_prrtecompress_zlib_CONFIG([action-if-can-compile],
#                          [action-if-cant-compile])
# ------------------------------------------------
AC_DEFUN([MCA_prrte_prrtecompress_zlib_CONFIG],[
    AC_CONFIG_FILES([src/mca/prrtecompress/zlib/Makefile])
    ...
    if test "$with_zlib" != "no"; then
        ...
        PRRTE_CHECK_PACKAGE([prrtecompress_zlib],
                           [zlib.h],
                           [z],
                           [deflate],
                           [-lz],
    ...
    AC_SUBST([prrtecompress_zlib_CFLAGS])
    AC_SUBST([prrtecompress_zlib_CPPFLAGS])
    AC_SUBST([prrtecompress_zlib_LDFLAGS])
    AC_SUBST([prrtecompress_zlib_LIBS])
