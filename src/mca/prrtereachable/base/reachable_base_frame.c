...
#include "src/mca/prrtereachable/base/static-components.h"
...
{
    return prrte_mca_base_framework_components_close(&prrte_prrtereachable_base_framework, NULL);
}

static int prrte_reachable_base_frame_open(prrte_mca_base_open_flag_t flags)
{
    /* Open up all available components */
    return prrte_mca_base_framework_components_open(&prrte_prrtereachable_base_framework, flags);
}

PRRTE_MCA_BASE_FRAMEWORK_DECLARE(prrte, prrtereachable, "PRRTE Reachability Framework",
                                 prrte_reachable_base_frame_register,
                                 prrte_reachable_base_frame_open,
                                 prrte_reachable_base_frame_close,
                                 prrte_prrtereachable_base_static_components, 0);
