...
int prrte_reachable_base_select(void)
{
     ...
     */
    if( PRRTE_SUCCESS != prrte_mca_base_select("prrtereachable", prrte_prrtereachable_base_framework.framework_output,
                                               &prrte_prrtereachable_base_framework.framework_components,
