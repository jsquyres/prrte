...
#include "src/mca/prrtereachable/prrtereachable.h"
#include "reachable_netlink.h"

/*
 * Public string showing the reachable netlink component version number
 */
const char *prrte_prrtereachable_netlink_component_version_string =
    "PRRTE netlink prrtereachable MCA component version " PRRTE_VERSION;
...
prrte_reachable_base_component_t prrte_prrtereachable_netlink_component = {
...
{
    *priority = 50;
    *module = (prrte_mca_base_module_t *) &prrte_prrtereachable_netlink_module;
    return PRRTE_SUCCESS;
}
