...
# MCA_prrte_prrtereachable_netlink_CONFIG([action-if-can-compile],
#                                   [action-if-cant-compile])
# ------------------------------------------------
AC_DEFUN([MCA_prrte_prrtereachable_netlink_CONFIG],[
    AC_CONFIG_FILES([src/mca/prrtereachable/netlink/Makefile])
