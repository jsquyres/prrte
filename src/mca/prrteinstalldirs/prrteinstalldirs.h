...
/**
 * Structure for prrteinstalldirs components.
 */
struct prrte_prrteinstalldirs_base_component_2_0_0_t {
    /** MCA base component */
 ...
 * Convenience typedef
 */
typedef struct prrte_prrteinstalldirs_base_component_2_0_0_t prrte_prrteinstalldirs_base_component_t;

/*
 * Macro for use in components that are of type prrteinstalldirs
 */
#define PRRTE_INSTALLDIRS_BASE_VERSION_2_0_0 \
    PRRTE_MCA_BASE_VERSION_2_1_0("prrteinstalldirs", 2, 0, 0)
