...
#include "src/mca/prrteinstalldirs/base/static-components.h"
...
static int
prrte_prrteinstalldirs_base_open(prrte_mca_base_open_flag_t flags)
{
    prrte_mca_base_component_list_item_t *component_item;
    int ret;

    ret = prrte_mca_base_framework_components_open (&prrte_prrteinstalldirs_base_framework, flags);
    if (PRRTE_SUCCESS != ret) {
        return ret;
    }

    PRRTE_LIST_FOREACH(component_item, &prrte_prrteinstalldirs_base_framework.framework_components, prrte_mca_base_component_list_item_t) {
        const prrte_prrteinstalldirs_base_component_t *component =
            (const prrte_prrteinstalldirs_base_component_t *) component_item->cli_component;
...
static int
prrte_prrteinstalldirs_base_close(void)
{
    ...
    return prrte_mca_base_framework_components_close (&prrte_prrteinstalldirs_base_framework, NULL);
}

/* Declare the prrteinstalldirs framework */
PRRTE_MCA_BASE_FRAMEWORK_DECLARE(prrte, prrteinstalldirs, NULL, NULL, prrte_prrteinstalldirs_base_open,
                                 prrte_prrteinstalldirs_base_close, prrte_prrteinstalldirs_base_static_components,
