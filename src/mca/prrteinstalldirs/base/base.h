...
/*
 * Global functions for MCA overall prrteinstalldirs open and close
 */
BEGIN_C_DECLS
 ...
 */
PRRTE_EXPORT extern prrte_mca_base_framework_t prrte_prrteinstalldirs_base_framework;

/* Just like prrte_install_dirs_expand() (see prrteinstalldirs.h), but will
   ...
   setup routines of prrteinstalldirs. */
