 ...
 * Apple
 */
prrte_if_base_component_t prrte_prrteif_bsdx_ipv6_component = {
...
static int if_bsdx_ipv6_open(void)
{
    ...
    prrte_output_verbose(1, prrte_prrteif_base_framework.framework_output,
    ...
    for (cur_ifaddrs = *ifadd_list; NULL != cur_ifaddrs;
        ...
        if (0 < prrte_output_get_verbosity(prrte_prrteif_base_framework.framework_output)) {
