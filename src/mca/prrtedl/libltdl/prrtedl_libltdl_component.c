...
#include "prrtedl_libltdl.h"


/*
 * Public string showing the sysinfo ompi_linux component version number
 */
const char *prrte_prrtedl_libltdl_component_version_string =
    "PRRTE prrtedl libltdl MCA component version " PRRTE_VERSION;
...
prrte_prrtedl_libltdl_component_t prrte_prrtedl_libltdl_component = {
...
static int libltdl_component_register(void)
{
    ...
    prrte_mca_base_component_var_register(&prrte_prrtedl_libltdl_component.base.base_version,
                                    "have_lt_dladvise",
...
static int libltdl_component_open(void)
{
    ...
    prrte_prrtedl_libltdl_component_t *c = &prrte_prrtedl_libltdl_component;
...
static int libltdl_component_query(prrte_mca_base_module_t **module, int *priority)
{
    /* The priority value is somewhat meaningless here; by
       ...
       available. */
    *priority = prrte_prrtedl_libltdl_component.base.priority;
    *module = &prrte_prrtedl_libltdl_module.super;
