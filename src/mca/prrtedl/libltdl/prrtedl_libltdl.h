...
PRRTE_EXPORT extern prrte_prrtedl_base_module_t prrte_prrtedl_libltdl_module;
...
struct prrte_dl_handle_t {
    lt_prrted.handle ltprrtedl_handle;
...
typedef struct {
    prrte_prrtedl_base_component_t base;
...
#endif
} prrte_prrtedl_libltdl_component_t;

PRRTE_EXPORT extern prrte_prrtedl_libltdl_component_t prrte_prrtedl_libltdl_component;
