...
PRRTE_EXPORT extern prrte_prrtedl_base_module_t prrte_prrtedl_dlopen_module;
...
} prrte_prrtedl_dlopen_component_t;

PRRTE_EXPORT extern prrte_prrtedl_dlopen_component_t prrte_prrtedl_dlopen_component;
