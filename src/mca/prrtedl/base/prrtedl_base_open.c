...
#include "src/mca/prrtedl/base/static-components.h"


/*
 * Globals
 */
prrte_prrtedl_base_module_t *prrte_prrtedl = NULL;
prrte_prrtedl_base_component_t *prrte_prrtedl_base_selected_component = NULL;
...
int prrte_dl_base_open(prrte_mca_base_open_flag_t flags)
{
    ...
    return prrte_mca_base_framework_components_open(&prrte_prrtedl_base_framework, flags);
}
...
/* VERY IMPORTANT: This framework is static, and is opened before any
   ...
   framework. */
PRRTE_MCA_BASE_FRAMEWORK_DECLARE(prrte, prrtedl, "Dynamic loader framework",
                                 NULL /* register */,
                                 prrte_dl_base_open /* open */,
                                 NULL /* close */,
                                 prrte_prrtedl_base_static_components,
