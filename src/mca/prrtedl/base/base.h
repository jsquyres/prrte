 ...
 * Globals
 */
PRRTE_EXPORT extern prrte_mca_base_framework_t prrte_prrtedl_base_framework;
PRRTE_EXPORT extern prrte_prrtedl_base_component_t
*prrte_prrtedl_base_selected_component;
PRRTE_EXPORT extern prrte_prrtedl_base_module_t *prrte_prrtedl;
 ...
 * Open a DSO
 *
 * (see prrte_prrtedl_base_module_open_ft_t in src/mca/prrtedl/prrtedl.h for
 ...
 *
 * (see prrte_prrtedl_base_module_lookup_ft_t in src/mca/prrtedl/prrtedl.h for
 * documentation of this function)
 */
 ...
 * Close a DSO
 *
 * (see prrte_prrtedl_base_module_close_ft_t in src/mca/prrtedl/prrtedl.h for
 * documentation of this function)
 */
 ...
 *
 * (see prrte_prrtedl_base_module_foreachfile_ft_t in src/mca/prrtedl/prrtedl.h for
 * documentation of this function)
 */
